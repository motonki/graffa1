...
Student name: Juho Pekkinen
Student number: 223683
Hours spent on requirements (approx.): 2.5
...
- What are you studying here at Aalto? (Department, major, minor...?) Computer science bachelor student, going to major in software and service engineering

- Which year of your studies is this? 7 since beginning in Aalto, second in CS

- Is ME-C3100 a mandatory course for you? nope

- Have you had something to do with graphics before? Other studies, personal interests, work? just watched compos in Assemby

- Do you remember basic linear algebra? Matrix and vector multiplication, cross product, that sort of thing? i think so

- How is your overall programming experience? What language are you most comfortable with? prob. python, then C and JS

- Do you have some experience with these things? (If not, do you have experience with something similar such as C or Direct3D?)
C++: a little
C++11: not sure?
OpenGL: indirectly, via pyglet

- Have you used a version control system such as Git, Mercurial or Subversion? Which ones? git

- Did you go to the technology lecture? yes

- Did you go to exercise sessions? no

- Did you work on the assignment using Aalto computers, your own computers, or both? own
